...
class LibraryRepository:
    ...
    def save_novel(cls, session: Session, meta: NovelMetadata) -> NovelMetadata:
        ...
        model.total_chapters = meta.total_chapters
        model.translated_chapters = meta.translated_chapters
        ...
        for ch in meta.chapters:
            seen_indices.add(ch.chapter_index)
        ...
        for idx, ch_model in list(existing_chapters.items()):
            if idx not in seen_indices:
                session.delete(ch_model)
